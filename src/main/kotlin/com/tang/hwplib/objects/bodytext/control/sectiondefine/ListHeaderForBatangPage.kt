...
class HWPBatangPageInfo {
    ...
    companion object {
         ...
         */
        fun build(listHeader: ListHeaderForBatangPage = ListHeaderForBatangPage.build(),
                  paragraphList: HWPParagraphList = HWPParagraphList.build())
                : HWPBatangPageInfo = HWPBatangPageInfo().apply {
